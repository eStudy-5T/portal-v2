...
function TestimonialSectionFour() {
  return (
    <div className="letmeet-testimonial-one edu-testimonial-area edu-section-gap bg-image">
          ...
          <div className="col-lg-6 col-12">
            <div className="satisfied-learner">
              <div className="thumbnail">
                <img
                  src="/images/testimonial-section/testimonial-01.jpg"
              ...
              <div className="trophy-content bounce-slide">
                <div className="icon">
                  <img
                    src="/images/testimonial-section/trophy.png"
                    alt="Trophy Images"
                  />
                </div>
