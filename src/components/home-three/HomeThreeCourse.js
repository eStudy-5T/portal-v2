...
function HomeThreeCourse() {
  return (
    <div className="edu-counterup-and-course-area">
      <CounterUpOne />

      <div className="edu-course-area letmeet-home-three-course counterup-overlay-top bg-image edu-section-gapTop edu-section-gapBottom">
