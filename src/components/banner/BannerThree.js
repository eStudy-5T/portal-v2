              ...
              <div className="inner">
                <div className="content text-start">
                  ...
                  <p className="description">
                    Sed eu volutpat arcu, a tincidunt nulla quam, feugiat sit
                    amet ipsum a, dapibus porta velit.{' '}
                  </p>
            ...
            <div className="col-lg-6">
              <div className="banner-image">
                <div className="banner-main-image">
                  <img
                    className="img-01"
                    src="/images/banner/banner-03/image-01.png"
                    alt="Banner Images"
                  />
                </div>
                <img
                  className="img-02"
                  src="/images/banner/banner-03/image-02.png"
                  alt="Banner Images"
                />
                <img
                  className="img-03"
                  src="/images/banner/banner-03/image-03.png"
                  alt="Banner Images"
                />
              </div>
            </div>
          ...
          <div className="shape-wrapper">
            <div className="shape-dot-wrapper shape-wrapper d-xl-block d-none">
              ...
              <div className="shape-image shape-image-3">
                <img
                  src="/images/shapes/shape-13-06-07.png"
                  alt="Shape Thumb"
                />
              </div>
