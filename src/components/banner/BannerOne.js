  ...
  return (
    <div className="slider-area banner-style-1 bg-image height-940 d-flex align-items-center">
          ...
          <div className="order-1 order-xl-2 col-lg-12 col-xl-6 banner-right-content">
            <div className="row g-5">
                  ...
                  <div className="inner">
                    <div className="thumbnail">
                      ...
                      <div className="top-position status-group left-top">
                        <span className="letmeet-status status-01 bg-primary-color">
                          UI Design
                        </span>
                      </div>
                    </div>
                    <div className="content">
                      <ul className="edu-meta meta-04">
                        ...
                        <li>
                          <i className="icon-time-line" />8 Hours 28 min
                        </li>
                      </ul>
                      <h6 className="title">
                        <Link to="/course-details/2">
              ...
              <div className="col-md-6 col-sm-6">
                <div className="video-thumbnail letmeet-hero-one-video">
                  <div className="thumbnail">
                    <img
                      className="w-100"
      ...
      <div className="scroll-down-btn">
        <ScrollTo className="round-btn" to="about-us" spy smooth duration={200}>
