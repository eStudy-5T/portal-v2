...
function AboutInstructor({ data, classes }) {
  return (
    <ScrollAnimation
      animateIn="fadeInUp"
      animateOut="fadeInOut"
      animateOnce
      className={classes || 'col-lg-4 col-md-6 col-sm-6 col-12 mt--45'}
    >
        ...
        <div className="edu-instructor">
          <div className="inner">
            <div className="thumbnail">
              ...
              >
                <img
                  src={`${process.env.PUBLIC_URL}/images/instructor/instructor-02/${data.image}`}
                  alt="Team Member"
                />
              </Link>
            </div>
            <div className="team-share-info">
              ...
              <a className="youtube" href={data.youtubeUrl}>
