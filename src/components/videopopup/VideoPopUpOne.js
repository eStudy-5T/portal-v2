  ...
  return (
    <div className={props.wrapperClass || 'thumbnail video-popup-wrapper'}>
      <img
        ...
        src={`${process.env.PUBLIC_URL}./images/videopopup/${
          props.imgSrc || 'video-popup-bg-01.jpg'
        }`}
        alt="Video PopUp Thumb"
      />

      <button
        className={`video-play-btn with-animation position-to-top video-popup-activation ${
