...
function VideoPopUpTwo() {
  const [toggler, setToggler] = useState(false)
  const videoLink = ['https://www.youtube.com/watch?v=pNje3bWz7V8']
  return (
    <div className="edu-feature-area letmeet-home-one-video edu-section-gap bg-color-white">
          ...
          <div className="col-lg-7 col-12 order-1 order-lg-2">
            <div className="feature-thumbnail">
              <div className="main-image video-popup-wrapper video-popup-two">
                ...
                <button
                  className="video-play-btn with-animation position-to-top btn-large video-popup-activation letmeet-video-play-icon color-secondary"
