...
function AboutFive({ wrapperClass }) {
  return (
    <div
            ...
            <div className="gallery-wrapper">
              ...
              <div className="image-2">
                <Parallax y={[-25, 15]} tagOuter="figure">
                  <img
                    src="/images/about/about-05/about-group-02.jpg"
                    alt="About Images"
                  />
                </Parallax>
              </div>
              <div className="image-3">
                <Parallax y={[40, -40]} tagOuter="figure">
                  <img
                    src="/images/about/about-05/about-group-03.jpg"
                    alt="About Images"
                  />
                </Parallax>
              </div>
            ...
            <div className="inner mt_mobile--40">
              ...
              <div className="feature-style-6 mt--40">
                ...
                >
                  <div className="icon">
                    <img
                      src="/images/about/about-05/student.png"
                      alt="Icons Images"
                    />
                  </div>
                ...
                >
                  <div className="icon">
                    <img
                      src="/images/about/about-05/book.png"
                      alt="Icons Images"
                    />
                  </div>
                  <div className="content">
                ...
                >
                  <div className="icon">
                    <img
                      src="/images/about/about-05/reward.png"
                      alt="Icons Images"
                    />
                  </div>
                  <div className="content">
