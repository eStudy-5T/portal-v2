              ...
              <div className="row g-5 align-items-end">
                <div className="col-lg-5 col-md-6">
                  <div className="gallery-image mt--85">
                    <img
                      className="w-100"
                      src="/images/about/about-04/gallery-1.jpg"
                      alt="Gallery Images"
                    />
                ...
                <div className="col-lg-7 col-md-6">
                  <div className="gallery-image">
                    <img
                      className="w-100"
                      src="/images/about/about-04/gallery-2.jpg"
                      alt="Gallery Images"
                    />
                  </div>
                </div>
                ...
                <div className="col-lg-12">
                  <div className="gallery-image gallery-image-3 text-center">
                    <img
                      src="/images/about/about-04/gallery-3.jpg"
                      alt="Gallery Images"
                    />
            ...
            <div className="inner">
              ...
              >
                <p className="description mt--40">
                  ...
                  risus, morbi pharetra. Facilisi sit miam mauris non iaculis
                  elit fusce amet nunc in odio molestie.
                </p>
              </ScrollAnimation>
              ...
              >
                <Link className="edu-btn" to="#">
                  Learn More <i className="icon-arrow-right-line-right" />
                </Link>
              </ScrollAnimation>
            </div>
          </div>
