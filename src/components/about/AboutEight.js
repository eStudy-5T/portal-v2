...
function AboutEight() {
  return (
    <div className="letmeet-home-five-about edu-about-area about-style-6 edu-section-gap bg-color-white">
          ...
          >
            <div className="about-image-gallery">
              <img
                ...
                src="/images/about/about-08/about-image-09.jpg"
                alt="About Thumb"
              />
              <div className="badge-icon">
                <div className="badge-inner">
                  <img
                    src="/images/about/about-08/badge.png"
                    alt="Icon Thumb"
                  />
                </div>
              </div>
            ...
            <div className="inner mt_md--40 mt_sm--20">
              ...
              <div className="feature-list-wrapper">
                <ScrollAnimation
                  ...
                  animateOnce
                >
                  <i className="icon-checkbox-circle-fill" />
              ...
              <div className="read-more-btn mt--75 mt_lg--30 mt_md--40 mt_sm--40">
                ...
                >
                  ...
                  <a className="info-btn" href="tel: +288 (394) 2783">
