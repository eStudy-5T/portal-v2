...
function AboutSix() {
  ...
  return (
    <>
      <div className="edu-workshop-area letmeet-home-three-video workshop-style-1 edu-section-gap bg-image bg-color-primary">
              ...
              <div className="workshop-inner">
                ...
                >
                  <p className="description">
                    ...
                    amet, consect adipi scing elit, sed do eiusmod tempor
                    incididunt ut sed do eiusmod tempor incididunt ut labore et
                    dolore aliqua.
                  </p>
                </ScrollAnimation>
                ...
                <ScrollAnimation
                  ...
                  animateOnce
                >
                  <Link className="edu-btn btn-white" to="/event-list">
                    More Upcomming Workshop
            ...
            <div className="col-lg-6 order-1 order-lg-2">
              <div className="thumbnail video-popup-wrapper">
                <img
                  ...
                  src={`${process.env.PUBLIC_URL}./images/videopopup/video-popup-bg-02.jpg`}
                  alt="Video PopUp Thumb"
                />
                <button
                  className="video-play-btn with-animation position-to-top video-popup-activation color-secondary size-60"
