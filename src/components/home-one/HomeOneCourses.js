...
import CourseTwo from '../course/CourseTypeTwo'
import CourseData from '../../data/course/CourseData.json'

function HomeOneCourses() {
  return (
    <div className="edu-course-area letmeet-home-one-course course-wrapper-1 edu-section-gap bg-color-white">
