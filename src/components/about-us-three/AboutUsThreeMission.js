...
function AboutUsThreeMission() {
  return (
    <div className="letmeet-about-three-mission edu-mission-vision-area edu-section-gap border-bottom-1 bg-color-white">
            ...
            <div className="thumbnail mb--50">
              <div className="shape-image image-1">
                <Parallax speed={1} y={[0, 40]} tagOuter="figure">
                  <img
                    src="/images/mission/mission-gallery-01.jpg"
                    alt="Gallery Images"
                  />
                </Parallax>
              </div>
              ...
              <div className="shape-image image-3">
                <Parallax speed={1} y={[0, 30]} tagOuter="figure">
                  <img
                    src="/images/mission/mission-gallery-03.jpg"
                    alt="Gallery Images"
                  />
                </Parallax>
              </div>
              <div className="shape-image image-4">
                <Parallax speed={1} y={[0, -18]} tagOuter="figure">
                  <img
                    src="/images/mission/mission-gallery-04.jpg"
                    alt="Gallery Images"
                  />
                </Parallax>
              </div>
            ...
            <div className="our-mission">
              <div className="section-title text-start">
                ...
                <p className="mt--30 mb--0">
                  ...
                  viverr praesent felis consequat pellentesque turpis et quisque
                  platea. Eu elit ut nuncu mauris bibendum nulla placerat.
                  Sagittis sit eu sit massa sapien, risus diam. In lorem eu sed
                  euismod laoreet urna, feugiat et. Euismod sem purus rutrum in.
                  Tortor varius a bibendum nisl et tellus.{' '}
                </p>
              </div>
            </div>
          </div>
