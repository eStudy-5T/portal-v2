...
import CourseTypeFour from '../course/CourseTypeFour'
import CourseData from '../../data/course/CourseData.json'

function HomeFourCourses(props) {
  return (
    <div
      className={`letmeet-home-four-courses edu-course-area edu-section-gap bg-image ${
