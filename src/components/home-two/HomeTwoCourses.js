...
import CourseTypeFilter from '../course/CourseTypeFilter'

function HomeTwoCourses() {
  const [toggler, setToggler] = useState(false)
  const videoLink = ['https://www.youtube.com/watch?v=pNje3bWz7V8']
  return (
    <>
      <div className="edu-course-area letmeet-home-two-course course-three-wrapper edu-section-gap bg-color-white">
                ...
                <div className="video-gallery-1">
                  <div className="thumbnail video-popup-wrapper">
                    <img
                      ...
                      src={`${process.env.PUBLIC_URL}./images/videopopup/video-popup-bg-01.jpg`}
