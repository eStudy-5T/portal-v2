...
function VideoSectionOne() {
  ...
  return (
    <>
      <div className="letmeet-home-four-video edu-video-area edu-section-gap video-style-2">
              ...
              <div className="pr--75 pr_lg--30 pr_md--0 pr_sm--0">
                <div className="thumbnail video-popup-wrapper">
                  <img
                    ...
                    src={`${process.env.PUBLIC_URL}./images/videopopup/video-popup-bg-03.jpg`}
            ...
            <div className="col-lg-4">
              <div className="content mt_md--40 mt_sm--40">
                ...
                <ScrollAnimation
                  ...
                  animateOnce
                >
                  <p className="description mt--40 mb--40 mt_md--20 mt_sm--20">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Amet, venenatis dictum et nec. Fringilla dictum tristique
                    cras pellentesque consequat. Learners on around the
