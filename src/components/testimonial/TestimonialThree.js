...
function TestimonialThree(props) {
  const sliderSettings = {
    dots: props.dots === 'enable',
    infinite: true,
    arrows: props.arrows !== 'disable',
    speed: 500,
    slidesToShow: 1,
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 4000,
    fade: props.fade !== 'disable',
    nextArrow: <NextArrow />,
    prevArrow: <PrevArrow />
  }
  ...
  const classes = `letmeet-testimonial-three inner testimonial-card-activation-1 slick-arrow-style-2 ${
