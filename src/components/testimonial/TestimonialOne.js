...
import { TestimonialOneParams } from '../../utils/configs/ui-config'
...
let data = [
  ...
  },
  {
    ...
    details:
      'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo perferendis accusantium ab temporibus possimus vel atque doloribus at voluptatum sapiente consectetur, explicabo dicta libero architecto beatae vitae voluptatibus corporis esse.',
        ...
        <div className="single-testimonial" key={i}>
          <div className="inner">
            ...
            <div className="client-information">
              <div className="thumb">
                <img
                  src={`${process.env.PUBLIC_URL}/images/testimonial/testimonial-01/${item.image}`}
                  alt="Client Thumb"
                />
              </div>
              <div className="info">
