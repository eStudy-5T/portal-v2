...
const AdvancedInformation = ({
  ...
  const onUploadVideo = (event) => {
    ...
    if (!file) {
      setUploadVideo(null)
      handleChangeAdvancedData(null, 'courseThumbnailVideo')
    } else {
      ...
      <Box sx={{ mt: 5, mb: 5 }}>
        <Grid container component="main" spacing={1}>
          ...
          <Grid item xs={12} md={6}>
            ...
            {courseAdvancedData?.courseThumbnailVideo && !uploadVideo && (
            ...
            {!uploadVideo && !courseAdvancedData?.courseThumbnailVideo && (
              <img
                src="/images/create-course/upload-video.png"
                alt="Thumbnail video"
              />
            )}
          </Grid>
          <Grid item xs={12} md={12} sx={{ mt: 2 }}>
            ...
            {!isFetching && (
              <CKEditor
                initData={courseAdvancedData?.whatStudentsGets}
                data={courseAdvancedData?.whatStudentsGets}
