                ...
                <div className="blog-details-1">
                  <div className="content-blog-top">
                    ...
                    <div className="thumbnail">
                      <img
                        ...
                        src={`${process.env.PUBLIC_URL}/images/blog/blog-details-02/${data.image}`}
                        alt="Blog Thumb"
                      />
                    </div>
                  </div>
                  ...
                  <div className="blog-main-content">
                    ...
                    <blockquote className="blockquote-style-1">
                      “ Duis vel scelerisque augue, ut vehicula nisl. Curabitur
                      et mollis tortor, eget sollicitudin lectus. Praesent a
                      ante ac urna ultrices volutpat at sed ligula. Phasellus
                      nibh dui, pulvinar a nibh quis. ”
                      <img
                    ...
                    <ul className="gallery gallery-column-2">
                      <li>
                        <img
                          src="/images/blog/gallery/gallery-01.jpg"
                          alt="Gallery Images"
                        />
                      </li>
                      <li>
                        <img
                          src="/images/blog/gallery/gallery-02.jpg"
                          alt="Gallery Images"
                        />
                      </li>
                    </ul>
